...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-55skpk3*u@2z5xph+^464&h-ermq2yf7!mrag@@t)(b!20_v(m')
...
CORS_ALLOWED_ORIGINS = [
    FRONTEND_URL,
    "http://localhost:1300",  # React development server
    "http://127.0.0.1:1300",
    "http://localhost:3000",  # Fallback for standard React port
    "http://127.0.0.1:3000",
]
